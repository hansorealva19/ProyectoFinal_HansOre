...
exports.register = async (req, res) => {
  try {
    const { nombres, apellidos, fecha_nacimiento, correo, celular, usuario, password, rol } = req.body;
    ...
    await pool.query(
      `INSERT INTO usuario (nombres, apellidos, fecha_nacimiento, correo, celular, usuario, password, rol) 
       VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
      [nombres, apellidos, fecha_nacimiento, correo, celular, usuario, hash, rol]
    );
